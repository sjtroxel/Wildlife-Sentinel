...
const SCOUT_NAMES = ['nasa_firms', 'noaa_nhc', 'gdacs', 'usgs_nwis', 'usgs_earthquake', 'drought_monitor', 'coral_reef_watch', 'glad_deforestation', 'nsidc_sea_ice', 'noaa_cpc'] as const;
